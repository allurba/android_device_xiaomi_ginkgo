...
git clone https://github.com/allurba/android_vendor_miuicamera.git vendor/miuicamera
git clone https://github.com/LineageOS/android_packages_resources_devicesettings.git packages/resources/devicesettings
git clone https://github.com/omnirom/android_device_qcom_sepolicy_vndr.git device/qcom/sepolicy_vndr
